...
<div id="page-main">
    <div id="result">        
        ...
        //逐筆顯示
        $sql = "SELECT * FROM `everyone2` order by id ASC";
	    $result = execute_sql($database, $sql, $link) ;
        ...
        for ($i=0 ; $i<$sum ; $i++){
            ...
            switch ( $temp[0] ){
                case "c01":   $bingo_str1 = "庇護壹獎" ;   break ;
                case "c02":   $bingo_str1 = "庇護貳獎" ;   break ;
                case "c02a":  $bingo_str1 = "庇護貳獎Ａ" ; break ;
                case "c02b":  $bingo_str1 = "庇護貳獎Ｂ" ; break ;
                case "c03":   $bingo_str1 = "庇護參獎" ;   break ;
                case "c70":   $bingo_str1 = "憨兒加碼獎";  break ;
        ...
        $sql= "SELECT COUNT(*) FROM `everyone2` WHERE bingo LIKE '不可抽獎'" ;
        $result = execute_sql($database, $sql, $link) ;
