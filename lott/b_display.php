                ...
                <div id="bingo_go1-2"><b>最新得獎：
                    <?php
                        if ( $after == 0 )                        
                            ...
                            $result = execute_sql($database, $sql, $link) ;
                            echo mysql_result($result,0,"id2")."&nbsp;&nbsp;".mysql_result($result,0,"name") ;
                        }
                    ?>
                    </b></div>
            </div>
        ...
        for ($i=0 ; $i<$sum ; $i++){
            ...
            if( mysql_result($result,$i,1) != "" ){            
                echo "<div class='bingo_total'>";
                    echo "<div class='bingo_name'><div class='bingo_name-1'>".mysql_result($result,$i,"dep")."</div><div class='bingo_name-2'>".mysql_result($result,$i,"name")."</div></div>";
                    echo "<div class='bingo_no'>第 ".mysql_result($result,$i,"no")." 人&nbsp;&nbsp;".mysql_result($result,$i,"id2")."&nbsp;</div>";
                echo "</div>";  
            }
        }        
