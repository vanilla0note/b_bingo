...
<div id="page-main">
    <div id="result">    
        ...
        <div class="bingo_name" style="width:375px"><b>獎項名稱</b></div>
        <div class="bingo_name" style="width:375px"><b>中獎姓名</b></div>
        ...
        for ($i=0 ; $i<$sum ; $i++){
            ...
            if( mysql_result($result,$i,"acc") == "true" ){
                ...
                if ( mysql_result($result,$i,"ordering") == "" && mysql_result($result,$i,"name") != ""){
                    ...
                    echo "<div id='goods_".mysql_result($result,$i,"no")."'     class='bingo_name' style='width:375px'>".mysql_result($result,$i,"goods")."</div>";
                    echo "<div id='name_".mysql_result($result,$i,"no")."'      class='bingo_name' style='width:375px'>".mysql_result($result,$i,"id2")."&nbsp;&nbsp;".mysql_result($result,$i,"name")."</div>";            
                    ...
                    echo "<div id='goods_".mysql_result($result,$i,"no")."'     class='bingo2_name' style='width:375px'>".mysql_result($result,$i,"goods")."</div>";
                    echo "<div id='name_".mysql_result($result,$i,"no")."'      class='bingo2_name' style='width:375px'>".mysql_result($result,$i,"id2")."&nbsp;&nbsp;".mysql_result($result,$i,"name")."</div>";            
                    ...
                    echo "<div class='bingo_no'>第 ".mysql_result($result,$i,"no")." 人</div>";
                    echo "<div class='bingo_name' style='width:375px'>".mysql_result($result,$i,"goods")."</div>";
                    echo "<div class='bingo_name' style='width:375px'></div>";            
